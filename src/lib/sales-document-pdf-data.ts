...
function additionalNotes(notes: string | null) {
  if (!notes) return "";
...
export async function buildSalesPdfData(
  ...
  if (!document || !document.documentNumber) return null;
  ...
  return {
    ...
    issueDate: date(document.issueDate) || "-",
    dueDate: date(document.dueDate),
    currency: document.currency,
    recipientName: document.recipientName,
    recipientCompany: document.recipientCompany,
    recipientEmail: document.recipientEmail,
    recipientEmailSecondary: document.recipientEmailSecondary,
    ...
    recipientCountry: document.recipientCountry,
    recipientTaxNumber: document.recipientTaxNumber,
    recipientVatNumber: document.recipientVatNumber,
    issuerName: document.issuerName,
    issuerAddress: document.issuerAddress,
    issuerCountry: document.issuerCountry,
    issuerVatNumber: document.issuerVatNumber,
    bankName: document.bankName,
    bankAccountName: document.bankAccountName,
    iban: document.iban,
    swiftBic: document.swiftBic,
    bookingReference:
      document.booking?.bookingReference ||
      document.bookingReferenceSnapshot,
    groupName: document.groupNameSnapshot,
    tourTitle: document.tourTitleSnapshot,
    departureDate: date(document.departureDateSnapshot),
    ...
    vatEn,
    vatBg,
    paymentEn: noteValue(document.notes, "PAYMENT_EN"),
    paymentBg: noteValue(document.notes, "PAYMENT_BG"),
    additionalNotes: additionalNotes(document.notes),
