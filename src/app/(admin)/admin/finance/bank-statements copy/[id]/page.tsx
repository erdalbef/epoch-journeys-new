...
export default async function BankStatementDetailPage({
  ...
  const [previousStatement, relatedReconciliation] = await Promise.all([
    ...
    <div className="mx-auto max-w-[1600px] space-y-6 p-4 sm:p-6 lg:p-8">
      ...
      <BankStatementManager
        ...
        relatedReconciliation={
          relatedReconciliation
            ? {
                id: relatedReconciliation.id,
                status: relatedReconciliation.status,
                difference: Number(relatedReconciliation.difference),
              }
            : null
        }
