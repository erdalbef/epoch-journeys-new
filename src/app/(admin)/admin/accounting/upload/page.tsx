...
const accountingCategories = [
  ...
  },
  {
    ...
    label: "06 – Owner / Personal Payments",
  },
  {
    value:
  ...
  },
  {
    ...
    label: "08 – Trip / Group Documentation",
  },
];
...
function isAccountingCategory(
  ...
  return Object.values(
    AccountingCategory
  ).includes(value as AccountingCategory);
}

export default async function AccountingUploadPage({
  searchParams,
}: PageProps) {
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-8">
      <div>
        <Link
          href={`/admin/accounting/${defaultYear}/${defaultMonth}`}
        ...
        <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-600">
          Upload and classify a document for
          the monthly accounting package.
          Where relevant, connect the document
          to the supplier, tour, booking,
          departure, or bank account.
        </p>
      </div>
        ...
        <div className="flex gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm leading-6 text-blue-800">
              ...
              should continue to use the dedicated
              Bank Statement module. This upload
              page is primarily for invoices,
              receipts, payment proofs, contracts,
      ...
      <form
        action="/api/admin/accounting/documents"
        method="POST"
        ...
        <section className="rounded-2xl border bg-white p-6 shadow-sm">
          <div className="mb-6">
            ...
            <p className="mt-1 text-sm text-slate-600">
              Define which monthly accountant
              package this document belongs to.
            </p>
          </div>
          ...
          <div className="grid gap-5 md:grid-cols-2">
            ...
            <div className="md:col-span-2">
              ...
              <p className="mt-1 text-xs text-slate-500">
                Choose a suggested value or enter
          ...
          <div className="grid gap-5 md:grid-cols-2">
            <div className="md:col-span-2">
              ...
              <input
                ...
                name="title"
                required
                placeholder="e.g. Hotel Roma August Invoice"
                className="mt-2 w-full rounded-lg border px-3 py-2.5 text-sm"
              />
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                name="description"
                rows={3}
                placeholder="Optional explanation of the document."
                className="mt-2 w-full rounded-lg border px-3 py-2.5 text-sm"
              />
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                name="notes"
                rows={3}
                placeholder="Optional internal accounting notes."
                className="mt-2 w-full rounded-lg border px-3 py-2.5 text-sm"
              />
            </div>
          </div>
        ...
        <section className="rounded-2xl border bg-white p-6 shadow-sm">
          <div className="mb-6">
            ...
            <p className="mt-1 text-sm text-slate-600">
              ...
              finding accounting documents later.
            </p>
          </div>
