...
function relatedRecordLabel(
  ...
  if (document.bankAccount) {
    return `Bank Account: ${document.bankAccount.name} Â· ${document.bankAccount.currency}`;
  }
  ...
  if (
    ...
    return `Departure: ${document.departureDate.tour.title} Â· ${formatDate(
      document.departureDate
        .date,
    )}`;
  }
